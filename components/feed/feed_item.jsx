...
const FeedItem = (props) => {
    ...
    return <div>
        <div className='mx-5 mb-6 flex justify-between items-start'>
            ...
            <div className='flex'>
                <div className="mr-1 border rounded-3xl border-color3 px-2 text-xs flex justify-center items-center textOrange3"><span>{`${showModel.babysAge(props.item)}, ${showModel.region(props.item)}, ${showModel.nick(props.item)}`}</span></div>
