      ...
      <div className="mx-5">
        <div className="my-4 text-right">
          <div className="flex justify-end">
            <span
              className={`flex items-center py-1.5 px-3 border border-solid rounded text-xs ${
                filterStatus().value ? "border-blue4 textBlue4" : "border-gary3 textGray4"
              }`}
              ...
              return (
                ...
                >
                  <div>
                    <div className="block relative">
                      ...
                      {item.bookmark ? (
                        ...
                        <img
                          ...
                          className="absolute bottom-3 right-2.5 w-4"
                          onClick={(e) => {
                            e.preventDefault();
                    ...
                    <div>
                      <span className="mr-1.5 py-1 px-1.5 rounded text-xs text-center textGray3" style={{ backgroundColor: "#f0f5f8" }}>
                        {item.subject}
                      </span>
                      <span className="mr-1.5 py-1 px-1.5 rounded text-xs text-center textGray3" style={{ backgroundColor: "#f0f5f8" }}>
                        {item.field}
