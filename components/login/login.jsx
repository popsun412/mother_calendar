      ...
      <div className="px-4 h-screen">
        ...
        <div className="px-6">
          ...
          <div className="flex items-center justify-center rounded-md bg-gray2 px-4 py-4">
            ...
            />
            <svg
              className={`w-6 h-6 ${showPassword ? "" : "textGray4"} `}
              fill="currentColor"
              viewBox="0 0 20 20"
          ...
          <div
            className="text-xs font-normal textGray3 mt-3.5 flex items-center justify-center underline underline-offset-2"
            onClick={() => router.push("/resendpw")}
          >
            비밀번호를 잊으셨나요?
          </div>
          <div className="flex flex-col mt-8 space-y-2">
            <button className="py-4 rounded-md text-sm font-bold text-white bg5" onClick={login}>
              로그인
            </button>
