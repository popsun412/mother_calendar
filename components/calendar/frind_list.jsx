    ...
    return (
        <div className="w-full h-full verflow-y-scroll scrollbar-hide bg-gray2">
            <div className="flex py-4 items-center relative">
                <span className="absolute top-0 right-0 bottom-0 left-0 flex justify-center items-center z-40">추천 계정</span>
                        ...
                        return (
                            <div className="flex flex-col bg-white rounded-lg py-4" key={_item.uid}>
                                ...
                                <div className="flex items-center justify-center">
                                    <span className="px-2 py-1 mb-4 text-xs font-normal border-blue3 textBlue1 rounded-full border text-center">{`${showModel.babysAge(_item)}, ${showModel.region(_item)}, ${showModel.nick(_item)}`}</span>
                                </div>
