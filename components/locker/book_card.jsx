...
export default function BookCard(props) {
    return <div className='flex mb-5' onClick={props.onClick}>
        <div className={`mr-4 ${props.item.image == null ? "bg-gray2" : ""}`}>
        ...
        <div>
            ...
            {props.item.regDt ? <div className='textGray3' style={{ fontSize: '13px' }}>{moment(props.item.regDt).format('YYYY.MM')} 구매</div> : <></>}
            <div>
