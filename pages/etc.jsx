            ...
            <div className="block relative" style={{ height: "26px" }}>
              <div className="block absolute right-0">
                <span className="bg-gray2 py-1.5 px-2 text-xs text-center textGray2 rounded flex items-center" onClick={clickOrder}>
                  <img src="/images/order_icon.png" className="w-4 mr-1" /> {order.label}
                </span>
              </div>
            </div>
            <div className="mt-5">
                ...
                return (
                  <Link href={{ pathname: "/item", query: { commonItemUid: item.commonItemUid } }} key={idx} passHref>
                    <div className="flex mt-5">
                      ...
                      <div>
                        <h3 className="text-base font-semibold mb-1.5" style={{ letterSpacing: "-0.3px" }}>
                          {item.name}
                        </h3>
                        <div className="flex">
                          <span className="py-1 px-1.5 mr-1.5 rounded text-xs textGray3" style={{ backgroundColor: "#f0f5f8" }}>
                            {item.subject}
                          </span>
                          <span className="py-1 px-1.5 mr-1.5 rounded text-xs textGray3" style={{ backgroundColor: "#f0f5f8" }}>
                            {item.field}
