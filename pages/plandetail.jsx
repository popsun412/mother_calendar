        ...
        <>
                ...
                <section className="mb-6">
                    <div className="block relative">
                        ...
                        <div className="block absolute bottom-0 left-0 mb-6 ml-5 mt-1 text-xs">
                            <span
                                className="mr-2 py-1 px-1.5 rounded textOrange1"
                                style={{ letterSpacing: "-0.12px", backgroundColor: "rgba(219, 239, 253, 0.2)" }}
                            >
                                {data.subject}
                            </span>
            ...
            <aside className="fixed max-w-500 bottom-0 left-0 right-0 z-100">
                <div className="relative mx-auto my-0 bg-white">
                    ...
                    >
                        <span className={`text-sm text-white text-center p-4 m-5 w-full rounded-md ${data.isMyPlan ? "bg-gray4" : "bg5"}`}>
                            내 캘린더에 등록하기
                        </span>
                    </nav>
                </div>
