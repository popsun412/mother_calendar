                    ...
                    <div>
                                ...
                                <div className="flex items-center justify-between w-full">
                                    <div className="flex items-center">
                                        <img
                                            ...
                                            className="w-10 relative -left-4 flex-shrink-0"
                                            onClick={() => {
                        ...
                        <main className="mt-12 pb-20">
                            <div className="grid grid-cols-3 text-center text-sm textGray4 border-b border-solid border-gray3" style={{ height: "40px" }}>
                                <div
                                    className={`font-semibold ${activeTab === 0 ? "textBlue4 border-b-3 border-solid border-blue4" : ""}`}
                                ...
                                <div
                                    className={`font-semibold ${activeTab === 1 ? "textBlue4 border-b-3 border-solid border-blue4" : ""}`}
                                    style={{ lineHeight: "40px" }}
                                    onClick={() => {
                                        setActiveTab(1);
                                    }}
                                ...
                                <div
                                    className={`font-semibold ${activeTab === 2 ? "textBlue4 border-b-3 border-solid border-blue4" : ""}`}
                                    style={{ lineHeight: "40px" }}
                                    onClick={() => {
                                        setActiveTab(2);
                                    }}
