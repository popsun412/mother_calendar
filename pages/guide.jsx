        ...
        <section className="mx-5" style={{ paddingTop: "18px" }}>
          <div className="flex mb-6 justify-between">
            ...
            <div>
              ...
              <div className="text-xs textGray3" style={{ letterSpacing: "-0.36px" }}>
                2022년 1월 31일
              </div>
            </div>
            <div className="flex">
              <div className="text-xs textOrange3 border border-solid border-color3" style={{ borderRadius: "13.5px", padding: "0 9px", maxHeight: "22px" }}>
                5세 5세 8세, 서울, 엄마표
              </div>
          ...
          <div className="flex mb-3">
            <div className="bg5 text-white text-xs px-1.5 rounded" style={{ paddingTop: "3px", paddingBottom: "3px" }}>
              국어
            </div>
          ...
          <div className="flex border border-solid rounded-md justify-center items-center" style={{ height: "38px" }}>
            <div className="textGray2 text-base font-semibold mr-1" style={{ letterSpacing: "-0.32px" }}>
              1주차
            </div>
            <div className="textGray2" style={{ fontSize: "15px", letterSpacing: "-0.3px" }}>
              우리아이 습관기르기 첫번째
            </div>
          </div>
        </section>
        <section className="mt-4">
          <ReactPlayer url="https://youtu.be/a5oTbhuROVw" playing={false} controls={true} width="100%" />
        </section>
        <section className="mt-4">
