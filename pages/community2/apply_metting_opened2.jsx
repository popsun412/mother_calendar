...
export default function ApplyMettingOpened2() {
    ...
    return <>
        <div className="w-full h-full flex flex-col overflow-auto border">
            {/* 헤더 */}
            ...
            <div className="pt-4 px-6 flex flex-col">
                <div className="flex flex-col space-y-8">
                    <div>
                        ...
                        <div className="flex space-x-3 mb-3 font-normal items-center">
                            <div className="border border-gary3 rounded-md textGray4 text-sm py-2 px-4 text-center">1팀</div>
                            <div className="border border-orange5 rounded-md textOrange5 font-normal text-sm py-2 px-4 text-center">아이랑</div>
                            <div className="border border-gary3 rounded-md textGray2 font-normal text-sm py-2 px-4 text-center">엄마만</div>
                            <div className="border border-gary3 rounded-md textGray2 font-normal text-sm py-2 px-4 text-center">아빠만</div>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="grid gap-3 grid-cols-4">
                            ...
                            <div className="relative">
                                <img src="/images/itme.png" alt="" className="w-full rounded-md" />
