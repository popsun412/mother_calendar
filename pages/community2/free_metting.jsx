...
import CommunityMember from "../../components/community2/community_member";
    ...
    <>
      <div className="w-full h-screen flex flex-col border overflow-y-auto">
        ...
        <div className="px-5 py-2 border-b border-gary3 overflow-hidden">
          ...
          <div className="textGray1 text-sm font-normal">저희 집에서 같이 보드게임해요! 5~7세가 가지고 놀만한 보드게임 많이 있으니 빈손으로 오셔도 돼요~</div>
        </div>
        {/* 아래 */}
        <div className="p-5">
          <div className="mb-4">
