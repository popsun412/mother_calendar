export default function Useinfo() {
    return <div className="p-5">
        <h1 className="font-black text-2xl text-center">엄마의 캘린더 서비스 이용약관</h1>
        <br />
        <br />
        <h2 className="font-black text-xl mb-4">제 1 장 총칙</h2>
        <h3 className="font-black text-lg mb-2">제 1 조(목적)</h3>
        <p>본 약관은 주식회사 LG유플러스(이하 ‘회사’)가 운영하는 엄마의 캘린더 서비스(이하 ‘서비스’)를 이용함에 있어 필요한 그 이용조건 및 절차에 관한 사항을 정함을 목적으로 합니다.</p>
        <br />
        ...
        <ul className="decimal ml-6">
            <div className="flex items-start">
                ...
                <span>‘서비스’란 구현되는 단말기(PC, 스마트폰, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 이용자가 이용할 수 있는 ‘엄마의 캘린더’ 관련 제반 서비스를 통칭합니다.</span>
            </div>
            <div className="flex items-start">
        ...
        <ul className="circleNumber">
            <div className="flex items-start">
                ...
                <span>회사는 본 약관의 내용을 이용자가 쉽게 알 수 있도록 서비스 홈페이지(mamadadacal.com) 의 초기화면(이하 ‘서비스 초기화면’)에 게시합니다. 다만, 약관의 구체적인 내용은 이용자가 연결화면을 통하여 볼 수 있습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
                <span>회사는 「약관의 규제에 관한 법률」, 「전자문서 및 전자거래기본법」, 「전자서명법」, 「정보통신망 이용촉진 및 정보 보호 등에 관한 법률」 등 관련 법령에 위배되지 않는 범위 에서 본 약관을 개정할 수 있습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">3</span>
                <span>회사가 약관을 변경하는 경우에는 적용일자 및 개정사유를 명시하여 현행 약관과 함께 회사 서비스 초기화면에 최소 적용일자 15일전부터 적용일자까지 고지합니다. 다만, 이용자에게 불리하게 약관의 내용을 변경하는 경우에는 적용일자 30일전부터 고지합니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">4</span>
                <span>회사가 제3항에 따라 약관 변경을 고지하면서 이용자에게 약관 변경 적용일까지 거부의사를 표시하지 아니할 경우 약관의 변경에 동의한 것으로 간주한다는 내용을 고지하였음에도 이용 자가 명시적으로 약관 변경에 대한 거부의사를 표시하지 아니하면, 회사는 이용자가 변경 약 관에 동의한 것으로 간주합니다.</span>
            </div>
            <div className="flex items-start">
        ...
        <p>본 약관에 명시되지 아니한 사항에 대해서는 「약관의 규제에 관한 법률」, 「전자문서 및 전자 거래기본법」, 「전자서명법」, 「정보통신망 이용촉진 및 정보 보호 등에 관한 법률」 등 관련법 령에 따릅니다.</p>
        <br />
        <br />
        ...
        <ul className="circleNumber">
            ...
            <div className="flex items-start">
                ...
                <div className="flex-auto flex flex-col">
                    <p>회사는 서비스 이용신청이 다음 각 호의 어느 하나에 해당하는 경우에 그 신청에 대하여 승낙제한 사유가 해소될 때까지 승낙을 유보할 수 있고, 승낙하지 아니하거나 이미 승낙된 후 에는 승낙 취소할 수 있습니다.</p>
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">3</span>
                <span>이용자는 이용자 정보에 변경이 있는 경우, 이용자 정보 수정 등의 방법으로 그 변경사항을 반영하여야 합니다. 이용자 정보 수정을 하지 않음으로써 발생하는 이용자의 손해에 대하여 회사는 아무런 책임을 지지 않습니다.</span>
            </div>
        </ul>
        <br />
        <br />
        ...
        <ul className="circleNumber">
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
                <span>회사는 천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스의 제공을 제한하거나 일시중지할 수 있습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">3</span>
                <div className="flex-auto flex flex-col">
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">4</span>
                <span>회사가 제2항 또는 제3항에 따라 서비스 이용을 제한하거나 중지하고자 하는 때에는 그 사유, 일시 및 기간을 정하여 이용자에게 통지합니다. 다만, 회사가 긴급하게 이용을 제한하거 나 중지해야 할 필요가 있다고 인정하는 경우에는 서비스 이용을 제한하거나 중지한 후 통지 할 수 있으며, 회사의 책임 없는 사유로 통지할 수 없는 경우에는 서비스 초기화면 게시로 통지한 것으로 간주합니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">5</span>
                <span>회사가 시스템 개선공사, 장비증설, 정기점검 등 서비스를 제공할 수 없는 불가피한 사유가 있어 서비스 제공을 일시적으로 중지하고자 하는 경우에는 그 사유 및 중지기간 등을 명시하 여 서비스 초기화면에 사전 공지하고 전화, 문자, E-mail, 우편 등을 통해 이용자 또는 그 대 리인에게 통보합니다. 다만, 회사가 긴급하게 이용을 중지할 필요가 있다고 인정하는 경우나 이용자의 귀책사유로 인하여 통보할 수 없는 경우에는 그러하지 아니합니다.
                </span>
            </div>
        </ul>
        <br />
        ...
        <ul className="circleNumber">
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">1</span>
                <span>본 서비스는 베타 서비스로, 회사는 베타 서비스 기간(2022.6.7.~2022.6.30.) 종료 후에는 이용자에 대한 공지 및 책임 없이 서비스 제공을 제한일시중지하거나 종료할 수 있습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
                <span>베타 서비스 기간 후, 향후 분할 또는 영업양수도로 인하여 본 서비스의 이용약관상 계약주체가 분할승계회사 또는 영업양수회사로 변경될 수 있습니다. 회사는 분할 또는 영업양수도 의 경우 개인정보 관련 법령에서 규정하는 절차 및 개인정보 보호조치를 모두 준수하며 안전 하게 개인정보를 이전할 것입니다.</span>
            </div>
        </ul>
        <br />
        <br />
        ...
        <ul className="circleNumber">
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
                <span>회사는 서비스를 제공하기 위한 시스템에 장애가 발생하는 경우 신속히 장애를 복구합니다. 다만, 천재지변, 비상사태 또는 기타 부득이한 경우에는 서비스를 일시 중단할 수 있습니다.</span>
            </div>
        </ul>
        <br />
        ...
        <div className="flex items-start">
            <div className="flex-auto flex flex-col">
                <p>회사는 다음 각 호에 해당하는 게시물이나 자료(댓글, 채팅, 메시지 등 본 서비스에서 제공하는 게시발송 방식을 통한 것은 모두 포함됩니다. 문장, 음향, 동영상 등 유형을 불문합니다.)가 다음 각 호의 경우에 해당한다고 판단하는 경우, 사전 통지 없이 조치(노출제한, 게시중단, 삭제 등)를 취할 수 있으며, 이에 대해 회사는 어떠한 책임도 지지 않습니다.</p>
                <ul className="subNumbering">
                    <div className="flex">
                        <span className="mr-2">1</span>
        ...
        <ul className="circleNumber">
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">1</span>
                <span>이용자는 본 약관에서 규정하는 사항과 기타 회사가 정한 제반 규정, 공지사항등 회사가 공지하는 사항 및 관계법령을 준수하여야 하며, 기타 회사의 업무에 방해가 되는 행위, 회사의
                    명예를 손상시키는 행위를 해서는 안됩니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">4</span>
                <span>이용자는 회사의 사전 승낙 없이 서비스를 이용하여 영업활동을 할 수 없으며,그영업활동 의 결과에 대해 회사는 책임을 지지 않습니다. 또한 이용자는 이와 같은 영업활동으로 회사 가 손해를 입은 경우, 이용자는 회사에 대해 손해배상 의무를 지며, 회사는 해당 이용자에 대해 서비스 이용제한 및 적법한 절차를 거쳐 손해배상 등을 청구할 수 있습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">5</span>
                <span>이용자는 회사의 명시적 동의가 없는 한 서비스의 이용권한, 기타 이용계약상의 지위를 타인 에게 양도, 증여할 수 없으며 이를 담보로 제공할 수 없습니다.</span>
            </div>
            <div className="flex items-start">
            ...
            <div className="flex items-start">
                ...
                <div className="flex-auto flex flex-col">
                    <p>이용자는 다음 각 호의 행위를 해서는 안되며,해당행위를 하는 경우에 회사는 이용자의 서비스 이용에 대하여 제재(이용제한, 이용중지, 강제탈퇴 등)를 가할 수 있습니다.</p>
                    <ul className="subNumbering">
                        <div className="flex">
                            <span className="mr-2">1</span>
                        ...
                        <div className="flex">
                            <span className="mr-2">7</span>
                            <p>본 서비스를 통해 얻은 정보를 회사의 사전 승낙 없이 서비스 이용 외의 목적으로 복제하거나, 이를 출판 및 방송 등에 사용하거나, 제3자에게 제공하는 행위</p>
                        </div>
                        <div className="flex">
                            <span className="mr-2">8</span>
                        ...
                        <div className="flex">
                            ...
                            <p>회사의 동의 없이 서비스 또는 이에 포함된 소프트웨어의 일부를 복사, 수정, 배포, 판매, 양도, 대여, 담보제공하거나 타인에게 그 이용을 허락하는 행위</p>
                        </div>
                        <div className="flex">
        ...
        <ul className="circleNumber">
            <div className="flex items-start">
                ...
                <div className="flex-auto flex flex-col">
                    ...
                    <ul className="subNumbering">
                        <div className="flex">
                            <span className="mr-2">1</span>
                            <p>이용자는 언제든지 회사에 해지의 의사를 통지함으로써 이용계약을 해지할 수 있습니다. 다만, 거래사기 등의 부정이용 방지를 위해 거래를 진행중이거나 거래 관련 분쟁이 발생한 이용자는 이용계약 해지 및 서비스 탈퇴가 특정 기간 동안 제한될 수 있습니다.</p>
                        </div>
                        <div className="flex">
                            <span className="mr-2">2</span>
                            <p>이용자가 이용계약을 해지하고자 할 때에는 본인의 신분을 확인할 수 있는 구비서류를 첨부하여 본인이 직접 서비스 홈페이지 등을 통하여 회사에게 해지를 신청하여야 하며, 해지 희망일 전까지 구비서류를 제출하여야 합니다.</p>
                        </div>
                        <div className="flex">
                            <span className="mr-2">3</span>
                            <p>이용자의 서비스 해지로 인해 발생한 불이익에 대한 책임은 이용자 본인이 져야 하며, 이용계약이 종료되면 회사는 이용자에게 부가적으로 제공한 각종 혜택을 회수할 수 있습니다.</p>
                        </div>
                    </ul>
                </div>
            </div>
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">3</span>
                <span>이용계약이 해지되면 법령 및 개인정보처리방침에 따라 이용자 정보를 보유하는 경우를 제외 하고는 이용자 정보나 이용자가 작성한 게시물 등 모든 데이터는 삭제됩니다. 다만, 이용자가 작성한 게시물이 제3자에 의하여 스크랩 또는 다른 공유 기능으로 게시되거나, 이용자가 제3 자의 게시물에 댓글, 채팅 등 게시물을 추가하는 등의 경우에는 다른 이용자의 정상적 서비 스 이용을 위하여 필요한 범위 내에서 서비스 내에 삭제되지 않고 남아 있게 됩니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">4</span>
        ...
        <ul className="circleNumber">
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">1</span>
                <span>회사는 서비스 이용과 관련하여 이용자에게 발생한 어떠한 손해에 대해서도 책임을 지지 않 습니다. 다만, 회사의 고의 또는 중대한 과실로 인하여 발생한 손해의 경우는 제외합니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
                <span>회사가 이용자로부터 서비스를 이용하지 못한 사실을 통지 받은 경우에 회사는 서비스 재개를 위해 가능한 조치를 취해야 하며, 서비스를 다시 이용할 수 있게 된 경우 이 사실을 이용자에게 통지하여야 합니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">3</span>
                <span>이용자는 본 약관 및 관계법령에 위반하거나 기타 이용자의 의무를 위반하여 회사 또는 타인에게 피해를 준 경우 그 손해를 배상할 책임이 있습니다.</span>
            </div>
        </ul>
        <br />
        ...
        <ul className="circleNumber">
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
                <span>회사는 법령상 허용되는 한도 내에서, 서비스와 관련하여 본 약관에 명시되지 않은 어떠한 구체적인 사항(서비스에 속한 콘텐츠 등)에 대한 약정이나 보증을 하지 않습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">3</span>
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">5</span>
                <span>회사는 이용자의 컴퓨터 환경이나 회사의 관리 범위에 있지 아니한 보안 문제로 인하여 발생하는 제반 문제 또는 현재의 보안기술 수준으로 방어가 곤란한 네트워크 해킹 등 회사의 귀 책사유 없이 발생하는 문제에 대한 책임을 지지 않습니다.</span>
            </div>
        </ul>
        <br />
        <br />
        ...
        <ul className="circleNumber">
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
                <span>이용자가 서비스 내에 게시하는 게시물은 검색결과 내지 서비스 및 관련 프로모션, 광고등에 노출될 수 있으며, 해당 노출을 위해 필요한 범위 내에서는 일부 수정, 복제, 편집되어 게 시될 수 있습니다. 이 경우, 회사는 저작권법 규정을 준수하며, 이용자는 언제든지 고객센터 또는 운영자 문의 기능을 통해 해당 게시물에 대해 삭제, 검색결과 제외, 비공개 등의 조치를 요청할 수 있습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">3</span>
                <span>회사가 위 제2항 이외의 방법으로 이용자의 게시물을 이용하고자 하는 경우에는 전화, 팩스, 전자우편 등을 통해 사전에 이용자의 동의를 얻어야 합니다.</span>
            </div>
        </ul>
        <br />
        ...
        <ul className="circleNumber">
            ...
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
                <span>회사는 이용자의 개인정보를 보호하기 위하여 개인정보 처리방침을 제정하고 서비스 초기화 면에 게시합니다. 개인정보 처리방침의 구체적 내용은 연결화면을 통하여 볼 수 있습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">3</span>
        ...
        <ul className="circleNumber">
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">1</span>
                <span>회사는 이용자의 실생활에 더욱 보탬이 되는 유용한 서비스를 제공하기 위하여 서비스에 위 치기반서비스를 포함시킬 수 있습니다. 회사가 포함시킬 수 있는 위치기반서비스는 이용자의 단말기기의 위치정보를 수집하는 위치정보사업자로부터 위치정보를 전달받아 제공하는 무료 서비스고, 구체적으로는 이용자의 현재 위치를 기준으로 특정 지역모임에 가입자격을 부여하 고 다른 이용자와 해당 지역과 관련된 게시물을 작성할 수 있도록 하는 서비스, 이용자의 현 재 위치를 이용한 생활 정보나 광고성 정보를 제공하는 서비스가 있습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
                <span>이용자는 회사 서비스와 관련된 개인위치정보의 이용, 제공 목적, 제공받는 자의 범위 및 위 치기반서비스의 일부에 대하여 동의를 유보하거나, 이용제공에 대한 동의의 전부 또는 일부 철회할 수 있으며, 일시적인 중지를 요구할 수 있습니다. 회사는 위치정보의 보호 및 이용 등 에 관한 법률의 규정에 따라 개인위치정보 및 위치정보 이용제공사실 확인자료를 6개월 이 상 보관하며, 이용자가 동의의 전부 또는 일부를 철회한 때에는 회사는 철회한 부분에 해당 하는 개인위치정보 및 위치정보 이용제공사실 확인자료를 지체 없이 파기하겠습니다.</span>
            </div>
        </ul>
        <br />
        <br />
        ...
        <p>회사는 이용자의 편의를 위해 서비스 이용과 관련된 각종 고지 및 기타 회사 서비스 홍보를 포함 한 다양한 정보를 회사 서비스에 표시하거나 이용자의 휴대폰 문자, 알림 메시지(Push Notification) 등으로 발송할 수 있습니다. 이 경우 이용자의 통신환경 또는 요금구조에 따라 이 용자가 데이터 요금 등을 부담할 수 있습니다. 이용자는 관련 법령상 필요한 내용을 제외하고는 언제든지 이러한 정보에 대한 수신을 거절할 수 있으며, 이 경우 회사는 즉시 위와 같은 정보를 보내는 것을 중단합니다. 이용자의 수신 거절로 인하여 이용자가 필요한 정보를 제공받지 못한 경우 그에 대하여 회사는 책임이 없습니다.</p>
        <br />
        <h3 className="font-black text-lg mb-2">제 24 조 (기타)</h3>
        <ul className="circleNumber">
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">1</span>
                <span>이용자가 본 약관을 준수하지 않은 경우에, 회사가 즉시 조치를 취하지 않더라도 회사가 가지고 있는 권리를 포기하는 것이 아니며, 본 약관 중 일부 조항의 집행이 불가능하게 되더라 도 다른 조항에는 영향을 미치지 않습니다.</span>
            </div>
            <div className="flex items-start">
                <span className="flex-shrink-0 rounded-full border w-4 h-4 flex items-center justify-center text-xs mt-1 mr-2">2</span>
